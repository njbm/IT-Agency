...
@section('main_contain')
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center">All Register SubCategory</h6>

            <div class="mb-3 d-flex justify-content-end">
                <a href="" class="btn btn-info tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-toggle="modal" data-target="#homeAddsubCategory"> <i class="fa fa-plus ml-0 mr-1"></i>Add New </a>
            </div>
                  ...
                  @if (count($sub_cat) > 0)
                    @foreach ($sub_cat as $sub_cat)
                      <tr>
                          ...
                          <td>
                            <a class="btn text-info mr-2" href="{{ route('admin.edit_subcategory', $sub_cat->id)}}"><i class="icon ion-compose tx-28"></i></a>
    ...
    <div id="homeAddsubCategory" class="modal fade effect-scale">
        ...
        <div class="modal-dialog modal-dialog-top" role="document">
          <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('admin.delete_subcategory') }}" method="post">
                    @csrf
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
