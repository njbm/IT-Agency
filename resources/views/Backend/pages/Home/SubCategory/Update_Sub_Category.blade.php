    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
              ...
              <a class="breadcrumb-item" href="{{route('admin.all_subcategory')}}"> <i class="icon ion-reply text-22"></i> All Sub Category</a>
            </nav>
        </div><!-- br-pageheader -->
          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.update_subcategory', $sub_category->id) }}" method="post">
                        @csrf
                        ...
                        <div class="row mt-4 ">
                          ...
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('admin.all_subcategory')}}" type="button" class="btn btn-secondary text-white mr-2" >Close</a>
