...
@section('main_contain')
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> All Client</h6>
            <div class="mb-3 d-flex justify-content-end">
                <!-- Button trigger modal -->
                <a href="" class="btn btn-info tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-toggle="modal" data-target="#homeAddclient"> <i class="fa fa-plus ml-0 mr-1"></i>Add New </a>
            </div>
            @if(count($errors) > 0)
              ...
              <table id="datatable1" class="table display responsive nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-25p">Client logo</th>
                  ...
                  @if (count($clients) > 0)
                    @foreach ($clients as $client)
                      <tr>
                          ...
                          <td>
                            <a class="btn text-info" href="{{ route('admin.edit_client', $client->id) }}"><i class="icon ion-compose tx-28"></i></a>
    ...
    <div id="homeAddclient" class="modal fade effect-scale">
    <div class="modal-dialog modal-lg modal-dialog-top" role="document">
        ...
        <form action="{{ route('admin.add_client') }}" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <div id="homeDeleteClient" class="modal fade">
        <div class="modal-dialog modal-dialog-top" role="document">
          <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('admin.delete_client') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
