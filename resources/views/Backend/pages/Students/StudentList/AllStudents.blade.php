    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="br-section-label mb-3 text-center">All Students</h6>

          <div class="mb-3 d-flex justify-content-end">
            <!-- Button trigger modal -->
            <a href="" class="btn btn-info tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-toggle="modal" data-target="#UserAdd"> <i class="fa fa-plus ml-0 mr-1"></i>Add New Student</a>
        </div>
