...
$(document).ready(function () {
    ...
    jQuery("#cat_id").on("change", function () {
        ...
        if (categoryID) {
            $.ajax({
                url: "/admin/home/blog-subcategory/" + categoryID,
                type: "GET",
                dataType: "json",
    ...
    jQuery("#sub_cat_id").on("change", function () {
        ...
        if (subcategoryID) {
            $.ajax({
                url: "/admin/home/blog-child-category/" + subcategoryID,
                type: "GET",
                dataType: "json",
                success: function (data) {
                    $("#child_cat_id").empty();
...
// ######### Home Technology  Delete Bootstrap model Model Script ##########

$(document).ready(function () {
    $(document).on("click", "#homeTechnologyDelete", function () {
        var technology_id = $(this).val();
        
        $("#homeDeleteTechnology").modal("show");
        $("#technology_id").val(technology_id);
    });
});

// ######### End Home Technology Delete Bootstrap model Model Script ##########

// ######### Home Specialized  Delete Bootstrap model Model Script ##########

$(document).ready(function () {
    $(document).on("click", "#homeSpecializedDelete", function () {
        var specialized_id = $(this).val();
        
        $("#homeDeleteSpecialized").modal("show");
        $("#specialized_id").val(specialized_id);
    });
});

// ######### End Home Specialized Delete Bootstrap model Model Script ##########

// ######### Home Specialized  Delete Bootstrap model Model Script ##########

$(document).ready(function () {
    $(document).on("click", "#homeTeamMemberDelete", function () {
        var teamMember_id = $(this).val();
        
        $("#homeDeleteTeamMember").modal("show");
        $("#teamMember_id").val(teamMember_id);
    });
});
